...
Coleta: Apify `apify/instagram-comment-scraper (ATENÇÃO: actor LEGADO, bate teto 50-80; o operacional hoje é apify/instagram-scraper resultsType:comments)` → **868/872 = 99,5% de cobertura** (3-4 faltantes = deletados/restritos; 102 replies aninhadas ficaram fora — limitação do actor na run). Verificação anti-fabricação: post-âncora com baseline de 7 dias antes cresceu monotonicamente em 6 métricas ✓.
